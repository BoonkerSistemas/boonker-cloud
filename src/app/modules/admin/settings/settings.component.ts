        ...
        this.panels = [
            {
                ...
                description:
                    'Visualiza los detalles de construcción de tu casa',
            },
            {
                id: 'account',
                icon: 'heroicons_outline:user-circle',
                ...
                description:
                    'En este módulo encontrarás la información referente a los diseños y renders de tu casa',
            },
            {
                id: 'security',
                ...
                description:
                    'En este módulo encontrarás los planos de todas las ingenierias de tu casa',
            },
            {
                id: 'plan-billing',
                ...
                title: 'Garantías',
                description:
                    'En ese módulo encontrarás el certificado de garantía de tu casa y el boonker book respectivo',
            },
            {
                id: 'notifications',
                ...
                description:
                    'Carga aquí los documentos referente a futuras ampliaciones',
            },
        ];
