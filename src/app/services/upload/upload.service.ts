...
export class UploadService {
    ...
    findAll(): Observable<any[]> {
        ...
        return this.httpClientService.get<UsuarioDto[]>(environment.url + this.nombreModelo,);
    }
    ...
    upload(file: File, type): Observable<HttpEvent<any>> {
        ...
        const req = new HttpRequest('POST', `${environment.url}${this.nombreModelo}`, formData, {
            reportProgress: true,
            responseType: 'json',
        });
